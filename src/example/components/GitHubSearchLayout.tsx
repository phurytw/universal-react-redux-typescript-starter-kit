...
export interface GitHubSearchProps extends RouteComponentProps<GitHubSearchParams> {
    route?: RouteConfig;
}

export class GitHubSearchLayout extends React.Component<GitHubSearchProps, {}> {
